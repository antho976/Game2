...
static func all() -> Array[Dictionary]:
	return [
		...
		study("recovery","Measured breathing",0,Vector2(300,320),{"endurance":2},[180,300],[3,6],[90,180],{"recovery":.10},"Each rank increases stamina recovery by 10%."),
		study("resolve","Unbroken resolve",0,Vector2(160,470),{"vitality":3,"recovery":2},[500],[12],[300],{"health":20,"stamina":10},"A final discipline: +20 maximum health and +10 maximum stamina. Combat will use these recorded bonuses."),
		...
		study("limits","Beyond the limit",1,Vector2(160,320),{"potency":2,"tempering":2},[250,450,700],[4,8,14],[120,240,420],{"upgrade_cap":1},"Each rank unlocks one more item upgrade, taking the limit from +5 to +8. Later attempts have lower base survival."),
		study("masterwork","Masterwork theory",1,Vector2(160,470),{"potency":4,"tempering":4,"limits":3},[1000],[20],[600],{"potency":.05,"survival":.08},"The final equipment study: +5 percentage points to future upgrade gains and +8 points to survival. The highest upgrade can never be guaranteed."),
		...
		study("charter","Guild charter",2,Vector2(160,320),{"bargaining":3,"efficiency":3},[600],[12],[300],{"shop_discount":.10,"forge_discount":.10},"A permanent agreement: another 10% off purchases and forging, for a total 25% discount in each."),
		...
		study("fellowship","Fourth research desk",3,Vector2(160,320),{"assistant":1,"fieldnotes":2},[650],[14],[480],{"slots":1},"Unlock the fourth and final simultaneous research project."),
